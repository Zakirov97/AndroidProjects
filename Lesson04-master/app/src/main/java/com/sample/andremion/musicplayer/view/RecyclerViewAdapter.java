...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    private List<MusicItem> mValuesFull;
    private List<MusicItem> mValuesSearch;
    public RecyclerViewAdapter(List<MusicItem> items) {
        mValues = items;
        mValuesFull = new ArrayList<>(items);
        mValuesSearch = new ArrayList<>(items);
    }
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence == null || charSequence.length() == 0) {
                ...
                for (MusicItem item : mValuesFull) {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            mValuesSearch.clear();
            mValuesSearch.addAll((List)filterResults.values);
